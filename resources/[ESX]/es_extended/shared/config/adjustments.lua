...
Config.DiscordActivity = {
    ...
    assetName = "logo_wind-tiktok", --image name for the "large" icon.
    assetText = "Base Template V4 Wind Studio", -- Text to display on the asset
    buttons = {
        { label = "Tebex", url = "https://wind-studio.tebex.io/" },
        { label = "Discord", url = "https://discord.gg/7SBn6ygS87" },
    },
    presence = "{player_name} [ID : {player_id}]",
